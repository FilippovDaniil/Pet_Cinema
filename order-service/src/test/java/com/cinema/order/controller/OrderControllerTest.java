...
class OrderControllerTest {
    ...
    void createFoodOrder_clientRole_returns403() throws Exception {
        FoodOrderRequest req = FoodOrderRequest.builder()
                .clientId(20L)
                .items(List.of(
                        FoodOrderRequest.FoodOrderItemRequest.builder().foodItemId(1L).quantity(1).build()
                ))
                .build();
    ...
    // ----------------------------------------------------------------
    // POST /api/orders/webhook/payment  (public endpoint)
    // ----------------------------------------------------------------
